...
//             <Text style={styles.modalTitle}>{editMode ? "✏️ Edit User" : "➕ Add User"}</Text>
...
//             />
//             <TextInput
//               style={[styles.input, errorFields.password && styles.errorBorder]}
...
//   modalButton: { padding: 10, borderRadius: 5, flex: 1 },
