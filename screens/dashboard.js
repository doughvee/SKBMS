...
//           // Calculate totalSpent based on fetched budgets
//           const spentTotal = data.reduce((acc, curr) => acc + (parseFloat(curr.spent) || 0), 0);
//           setTotalBudgetLeft(prev => yearlyBudget - spentTotal);
//         }
//       });
//   }, [yearlyBudget]);
...
//       <TouchableOpacity style={styles.addBtn} onPress={() => setShowBudgetForm(!showBudgetForm)}>
//         <Text style={styles.addBtnText}>{showBudgetForm ? 'Cancel' : 'Add Yearly Budget'}</Text>
//       </TouchableOpacity>
...
//                 <Progress.Circle
//                   size={150}
//                   progress={yearlyBudget ? (yearlyBudget - totalBudgetLeft) / yearlyBudget : 0}
//                   showsText={true}
//                   formatText={() =>
//                     `${Math.round(((yearlyBudget - totalBudgetLeft) / yearlyBudget) * 100)}%`
//                   }
//                   color="#ff5252"
...
//                 <Text style={{ color: '#28a745', fontWeight: 'bold', marginTop: 5 }}>
//                   Remaining: ₱ {totalBudgetLeft.toLocaleString()}
//                 </Text>
//                 <Text style={{ color: '#ff5252', fontWeight: 'bold' }}>
//                   Spent: ₱ {(yearlyBudget - totalBudgetLeft).toLocaleString()}
//                 </Text>
//               </View>
//             </View>
...
//   <Text style={[styles.budgetText, styles.headerText]}>Name</Text>
//   <Text style={[styles.budgetText, styles.headerText]}>Budget</Text>
//   <Text style={[styles.budgetText, styles.headerText]}>Spent</Text>
// </View>
...
const Dashboard = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {/* Hide the Add Yearly Budget button when the form is shown */}
      <TouchableOpacity
